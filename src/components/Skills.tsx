...
      iconBg: "bg-gradient-to-r from-orange-600 to-yellow-600",
      borderColor: "border-orange-200 hover:border-yellow-400",
      tagBorder: "border-orange-300",
    },
  ];
...
          <div className="w-20 h-1 bg-gradient-to-r from-blue-600 via-pink-600 to-orange-600 mx-auto mb-6"></div>
