                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-3">
                    ...
                    {project.title === "FitSpace – User-Centered Design Platform" ? (
                      ...
                      // Original button structure for all other projects (Code and Demo)
                      <>
                        <Button
                          size="sm"
                          variant="outline"
                          ...
                          asChild
                        >
                          {/* This button is now using the updated project.github link */}
                        ...
                        <Button
                          ...
                          asChild
                        >
                          {/* This button is now using the updated project.demo link */}
