      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            A selection of projects that demonstrate my skills in data analysis, software development and system design.
          </p>
        </motion.div>
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-3">
                    ...
                    {project.title === "Design Case Study - Teambuildr" ? (
                      ...
                      <>
                        {/* Updated HERE — Report → Presentation **ONLY** for the hotel project */}
                        <Button
                          size="sm"
                          variant="outline"
                          className={`flex-1 ${project.buttonColor}`}
